			...
			return _react2.default.createElement(
				_reactPopper.Popper,
				{
					ref: function ref(_ref5) {
						return _this9.menuContainer = (0, _reactDom.findDOMNode)(_ref5);
					},
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ ref: function ref(_ref6) {
							...
							className: (0, _classnames2.default)('Select-control', { 'Select-control--on-bottom': this.state.placement === 'bottom' }, { 'Select-control--on-top': this.state.placement === 'top' }),
